          ...
          {/* cart Items */}
           <div className="row d-flex justify-content-between cartt">
            ...
            <div className="row">
              ...
              {/* Remove item button */}
              <div className="col-4 col-lg-1 mt-4 mt-lg-4">
                <i 
                id="delete_cart_item"
                className="fa fa-trash btn bth-danger"
             ...
             <div className="col-12 col-lg-3 my-4">
              <div id="order_summary">
                ...
                <p>
                  Subtotal:
                  <span className="order-summery-values">
                    {cartItems.reduce((acc, item) => acc + Number(item.quantity),
                    0
                    )}
                    (Units)
                  </span>
